"""Script to run random hyperparameter search for training a YOLOv10s model the
...
import pyronear_mlops.model.yolo.hyperparameters.yolov10 as hyperparameters
...
def make_cli_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        default="./data/03_model_input/yolov10/small/datasets/data.yaml",
        type=Path,
    )
    parser.add_argument(
        "--output-dir",
        help="path to save the model_artifacts",
        default="./data/04_models/yolov10/",
        type=Path,
    )
    parser.add_argument(
        "--experiment-name",
